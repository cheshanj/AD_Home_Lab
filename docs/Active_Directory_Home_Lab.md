...
In this lab, I have set up several virtual machines in VirtualBox to simulate a real-world Active Directory environment. The lab is inspired by several online tutorials. I have listed them at the end of the report.
